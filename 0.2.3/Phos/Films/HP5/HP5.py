...
def opt (lux):
    ...
    lux = lux * 0.95 + bloom_effect * 0.05 - weights * 0.05
    #将光晕效果叠加回底片
...
def neg_tone(lux):
    ...
    result = np.clip((0.669 - Pt)*1.50, 0, 1) #将透光率映射回亮度，反转并裁切到0-1范围
